...
function analyzeQuery(
    q: string,
    data: import("@/utils/types").DataRow[],
    variables: import("@/utils/types").SavVariable[],
    valueLabels: import("@/utils/types").ValueLabels,
    numericVars: import("@/utils/types").SavVariable[],
    weights: number[] | null
): string {
